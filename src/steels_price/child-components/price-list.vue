<script>
	import { Table, TableColumn, Button, Input, Select, Option, Dialog ,Form,FormItem,Pagination} from 'element-ui';
	...
	export default{
		...
		methods : {
			...
			saveProjectInfo(data){
				window.$vueData.projectInfo = JSON.parse(JSON.stringify(this.userProjectInfo));
			}
		}
	}
</script>
