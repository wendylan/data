<script>
	...
	export default{
		...
		created : function(){
			ajaxCustom.ajaxGet(this, "dingoapi/getUserProjectOrder", (response)=>{
	...
	<div class="main-warpper">
		...
		<el-dialog :visible.sync="dialogOrderVisible" title="钢材采购确认表" style="text-align:center;" size="middle">
			...
			<div style="text-align:left;">
				...
				<p>
					<span>供货时间:</span>
					<el-date-picker type="date" placeholder="请选择日期" v-model="buyData.supply_time"></el-date-picker>
				</p>
				<p>
					<span>付款时间:</span>
					<span>见合同</span>
			...
			<div slot="footer" class="dialog-footer" style="clear:both;text-align:center;">
				...
				<el-button type="danger" @click="cancelOrder">取消下单</el-button>
				<el-button type="primary" @click="finishOrder">发送下单</el-button>
			</div>
		</el-dialog>
		<!-- 钢材采购确认表的弹出框结束 -->
