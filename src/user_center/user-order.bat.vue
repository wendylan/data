	...
	<div class="main-warpper">
		...
		<el-dialog :visible.sync="dialogOrderVisible" title="钢材采购确认表" style="text-align:center;" size="middle">
			<p style="text-align:left;" v-show="this.buyData.status !=0">
				...
				<span v-if="this.buyData.status<0 || this.buyData.status==3 "><span class="bg" >2 </span><b style="color:#20a0ff;">待确认订单 ></b></span>
				<span v-if="this.buyData.status==3"><span class="bg" >3 </span><b style="color:#20a0ff;">已确认 ></b></span>
				<span v-if="this.buyData.status<0"><span class="bg" style="background:#FF4949;">3 </span><b style="color:#FF4949;">已取消 ></b></span>
      		</p>
			...
			<div style="text-align:left;">
				...
				<el-input v-model="buyData.settlement" type="text" size="small" style="display:inline-block;width:67%;"></el-input>
			</div>
			<div style="text-align:left;">
				<label>
			...
			<div style="text-align:left;">
				...
				<p>
					<span>供货时间:</span>
					<el-date-picker type="date" :picker-options="pickerOptions1" placeholder="请选择日期" v-model="buyData.supply_information.supply_time" size="small"></el-date-picker>
				</p>
				<p>
					<span>付款时间:</span>
					<span>见合同</span>
